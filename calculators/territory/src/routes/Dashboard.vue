...
section.section(style='padding-top: 0')
  .hero.is-primary.mb-2.mx-r
    .hero-body: .container
      .columns
        .column
          .title Territory Calculator
          .subtitle paste your "territory clan" list
  .columns
    .column
      .is-size-4 paste inside this area
      b-icon(icon='hand-pointing-down')
      b-input(type='textarea',@input='updateAreas',rows='20')
    .column
      .is-size-4 this will be unconquered areas
      b-icon(icon='hand-pointing-down')
      b-input(type='textarea',v-model='areaOutput',rows='20')
</template>
<script>
const areas = [
  'Eastern Moors (1-20)',
